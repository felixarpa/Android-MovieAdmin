package com.example.pr_idi.mydatabaseexample.domain.dataInterface;
...
import com.example.pr_idi.mydatabaseexample.data.MySQLiteHelper;
import com.example.pr_idi.mydatabaseexample.domain.model.Film;
...
public class FilmData {
    ...
    public Film createFilm(String title, String director) {
        ...
        values.put(MySQLiteHelper.COLUMN_YEAR, 2014);
        values.put(MySQLiteHelper.COLUMN_MAIN_CHARACTER, "Do not know");
        values.put(MySQLiteHelper.COLUMN_RATE, 5);
